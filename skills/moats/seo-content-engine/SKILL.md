...
description: >
  Stand up and operate an SEO content engine: audit current state, identify gaps,
  build keyword architecture, generate a content calendar, draft content.
---
...
- Work the target keywords in naturally
...
- Every page links to relevant pillar content

### 7. Publish & Monitor

- Publish on the client's blog/site (or provide drafts for the client to publish)
...
- **Monthly**: Review content performance, update the calendar, refresh underperforming pages
- **Quarterly**: Re-run seo-content-audit to measure progress and identify new gaps

## Human Checkpoints

- **After Step 2**: Review the gap analysis and priority recommendations
- **After Step 4**: Review the content calendar before drafting
