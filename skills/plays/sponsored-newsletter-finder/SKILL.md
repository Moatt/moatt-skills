...
description: >
  Discover newsletters in a target niche that reach your ICP, evaluate audience fit,
  estimate reach and CPM, and produce a ranked shortlist of sponsorship opportunities.
  Uses web search to surface newsletters, then scores each against ICP alignment
  criteria. Use when a marketing team wants to reach an existing engaged audience for
  less than the cost of building their own, or when testing a new channel before
  committing.
tags: [ads]
---
...
Find newsletters your ICP reads, evaluate audience fit, and produce a ranked shortlist ready for outreach. Cheaper and faster than building your own list from scratch — newsletters already have the trust and the audience.

**Best for:** seed/Series A teams with $500-5,000/month to test a paid distribution channel. Not for companies without budget or companies aiming at a mass-market ICP.
...
Search for newsletters across multiple angles:
...
For each discovered newsletter, score on 5 dimensions (1-5 each):
...
For newsletters with no pricing page, estimate CPM using industry benchmarks:
...
Check whether known competitors are sponsoring newsletters in this space:
...
If a competitor is sponsoring a newsletter, audience fit is validated — flag it as high priority.
...
### Cold outreach to a newsletter with no sponsor page:
