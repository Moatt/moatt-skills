...
description: >
  For founders who don't know where to start with paid ads. Analyses ICP,
  competitor ad presence, budget constraints, and product type to recommend the
  1-2 paid channels worth starting with, plus a 90-day ramp plan. Prevents the
  common mistake of spreading a tiny budget across too many platforms.
tags: [ads]
---

# Paid Channel Prioritizer

Answer the question every early-stage founder asks: "Where should I run ads?" This skill weighs your product, ICP, competitors, and budget to recommend the right 1-2 channels to begin with — plus a 90-day plan to get there.

**Core principle:** A $3K/month ad budget split across Google, Meta, LinkedIn, and TikTok works out to $750/channel — not enough for any platform to learn and optimise. This skill picks the best 1-2 channels and concentrates budget where it'll compound fastest.
...
3. **B2B or B2C?** — Heavily influences channel selection
4. **ICP** — Who are you selling to? (Role, company size, industry)
5. **Monthly ad budget** — Be honest — how much can you actually spend?
6. **Average deal size / LTV** — What's a customer worth?
7. **Current acquisition channels** — How are you winning customers today? (Organic, referral, outbound, etc.)
...
Use web search to check publicly accessible ad libraries and surface competitor ad intelligence:
...
The Meta Ad Library (facebook.com/ads/library) and Google Ads Transparency Center (adstransparency.google.com) are publicly accessible — search them to see what competitors are running.
...
**Insight:** Where competitors are spending = validated channel. Where they're absent = either opportunity or dead end.

### 1C: Channel Scoring Matrix

Score each channel for this particular product:
...
| **Meta (FB/IG)** | Visual products, B2C, retargeting, lookalikes | Niche B2B with a tiny audience | $1K/mo | Images + video (medium) |
...
2. Budget viability (can they afford the minimum viable spend?)
...
- It addresses a different funnel stage than channel #1
...
| $7K+/mo | **2-3 channels** — diversify with a testing budget |
...
- Build the landing page (if needed)
- Build initial audiences / keyword list
- Launch 2-3 ad variants on the primary channel

**Week 2-3: Learn**
- Collect data — do NOT optimise yet
- Monitor for setup issues (tracking, disapprovals, targeting)
- Wait for at least 500 impressions per variant before judging

**Week 4: First Optimisation**
- Pause the worst-performing ad variant
- Add 1-2 new variants based on early signals
- Adjust bids/budgets using CPM/CPC data

### Month 2: Optimize (Days 31-60)

- Review conversion data — any ads producing results?
- Launch retargeting (if not already running)
...
Save to `channel-strategy-[YYYY-MM-DD].md` in the current working directory (or a user-specified path).
