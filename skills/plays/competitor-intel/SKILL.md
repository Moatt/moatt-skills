...
description: >
  Competitor intelligence system. Research competitors across the web, Reddit,
  Twitter/X, LinkedIn, and blogs. Build deep competitor profiles, monitor
  content and positioning changes, track what gains traction, and identify
  competitive gaps. Covers data collection, content tracking, and strategy
  analysis. Pure research skill — uses web search, web fetch, and optionally
  Apify for social scraping. No scripts required.
---

# Competitor Intelligence

Research and monitor competitors across many channels. Build profiles, track changes, and turn competitor moves into strategic recommendations.

**Three layers:**
1. **Data collection** — Research competitor activity across the web, Reddit, Twitter/X, LinkedIn, and blogs
...
- Who's their ICP? (check marketing copy, case studies)
...
### Product & Positioning
- Core value proposition (from the homepage hero)
...
### Content & Marketing
- Blog topics and frequency (fetch /blog, check the RSS feed)
...
If Apify is configured, scrape deeper data:
- **Reddit mentions:** Search for competitor name across relevant subreddits
- **Twitter/X activity:** Track the competitor's account and founder's recent posts
- **LinkedIn posts:** Track founder/CMO LinkedIn content and engagement

Without Apify, web search still covers the basics — just less structured.
...
Once every competitor is profiled, produce a landscape view:
...
**What to monitor:**
- Pricing page changes (compare against the last snapshot)
