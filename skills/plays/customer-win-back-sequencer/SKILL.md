...
description: >
  For churned accounts, research what has shifted since they left — new funding,
  team growth, competitor dissatisfaction, product updates that target their old
  pain — then size up re-engagement potential and generate a personalized
  win-back email sequence with timing guidance. Chains web research and LinkedIn
  monitoring with email sequence generation.
tags: [outreach]
---

# Customer Win-Back Sequencer

Not every churned customer is permanently gone. This skill identifies which ones are worth pursuing, finds the right re-engagement angle, and produces a personalised win-back sequence. Timing and relevance are everything — no generic "we miss you" emails.

**Built for:** Startups whose churned customers are sitting in a spreadsheet with no plan to reach back out. The best win-back campaigns are triggered by change — this skill watches for those changes and strikes when the timing is right.
...
3. **Minimum value** — Only pursue accounts above $X MRR? (Focus effort on winning back the accounts that matter)
...
For each account on the churn list, research what's changed:
...
- **Growth:** Headcount climbing? New hires in relevant roles?
- **Product changes:** Launched something new that would benefit from your product?
- **Market moves:** Entered a new market, struck new partnerships?
...
- Reviews mentioning problems your product solves
- Signs of "buyer's remorse" in the market

### 1D: Product-Churn Fit Analysis

Map what's changed in your product against their churn reason:
...
| "Champion left" | N/A — find a new champion | Fresh start narrative |
| "Company downsized" | Company growing again (from research) | Timing-based re-engagement |
...
- Sequences: [Use the sequences generated above]
