...
Environment:
    ...
    AGENTMAIL_INBOX:   Inbox address (default: moatt@agentmail.to)
"""
...
def main():
    ...
    parser.add_argument(
        "--inbox",
        help="Override inbox address (default: AGENTMAIL_INBOX env or moatt@agentmail.to)",
    )
    parser.add_argument(
        "--limit",
        type=int,
    ...
    # --- Resolve inbox ---
    inbox = args.inbox or os.getenv("AGENTMAIL_INBOX", "moatt@agentmail.to")
