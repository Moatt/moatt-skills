...
description: >
  Build a complete marketing campaign brief from a launch goal, ICP, and product context.
  Pure reasoning skill. Emits channel plan, messaging angles, content types, timeline,
  and success metrics. Built for seed/Series A founders and small GTM teams without a
  professional marketer on staff who still need to run focused campaigns. No scripts —
  pure reasoning.
tags: [content]
---
...
Pure reasoning skill. Takes a campaign goal, ICP, and product context — and emits a complete, actionable brief a small team can actually execute.

**Built for:** Founders doing their own marketing. First marketing hires. GTM teams without a dedicated strategist. The output is opinionated and specific, not a generic template.
...
Ask everything in one pass, grouped cleanly. This is a fast skill — don't make it feel like a form.
...
10. **What you're NOT** — Key competitor or alternative you want to differentiate from
...
Based on intake, recommend 2-4 primary channels. For seed/Series A, resist suggesting more than 4 — execution quality beats channel breadth.
...
| **LinkedIn ads** | Targeted awareness with a limited list | $1,000+/month budget |
...
Define 3 core messages — the angles you'll repeat across channels.
...
Map specific content pieces to the channel plan. Be concrete — give working titles, not "write some blog posts."
