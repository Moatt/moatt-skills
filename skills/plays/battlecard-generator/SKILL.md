...
description: >
  Research a specific competitor across their website, reviews, ads, social
  presence, and pricing — then produce a structured sales battlecard with
  positioning traps, objection handlers, landmine questions, and win/loss
  themes. Chains web research, review mining, and ad intelligence. Reach
  for this when sales needs competitive ammo or when entering a new market
...
Researches a competitor from every public angle — website, reviews, ads, social, pricing — and produces a structured sales battlecard. The output is what a rep opens 5 minutes before a competitive deal.
...
2. **Competitor name + URL** — One competitor per battlecard (focused beats broad)
...
6. **Existing positioning** — Your one-line positioning against this competitor (if any)
...
Extract:
- **Common frustrations** people discuss publicly
- **Feature requests** their users are vocal about
- **Sentiment patterns** — do users love them or tolerate them?
...
**Pricing attack angle:** [How to frame the pricing comparison favorably]
