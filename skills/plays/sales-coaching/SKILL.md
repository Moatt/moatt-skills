...
version: 1.0.0
description: >
  AI sales coach composite. Pulls in every available sales signal — email campaigns,
  call recordings/transcripts, reply patterns, pipeline outcomes — to identify what
  the user does well, where they struggle, and how to improve. Surfaces patterns in
  top-performing emails, winning call moves, successful objection handles, and deal
  progression. Produces personalized coaching tied to their specific product, market,
  and selling style. Tool-agnostic.
tags: [research]
---

# Sales Coaching

An AI coach that studies everything you do in sales — your emails, your calls, your deals — finds the patterns in what works and what doesn't, and delivers specific, actionable coaching to get better.
...
- After a bad quarter/month, when the user wants to diagnose personal performance
...
- `"sales_leader"` — Focus on team patterns, not just the individual
...
**Purpose:** Pull every available sales signal. The more data types, the richer the coaching. But the system works with whatever's available.
...
Across every campaign, find:
- **Highest reply-rate subject lines** — What do they share?
- **Highest reply-rate email bodies** — What patterns recur?
- **Emails that produced positive replies** — What specifically triggered interest?
- **Emails that produced meetings** — The gold standard. What did they say?
...
- What do low-reply emails share?
- Are there anti-patterns? (Long emails, generic openers, weak CTAs, no proof)
- Is there a consistent flaw running across campaigns?
...
Across every reply classified as an objection:
...
**Purpose:** When call transcripts or recordings exist, analyze how the user performs on calls. When no call data exists, skip this step.
...
| **Longest monologue** | Longest uninterrupted stretch by the seller | >90 seconds = lecturing, not selling. Keep it under 60s. |
...
|-----------|--------------|-------------|
| **Pain discovery** | Did you uncover real pain? | Good: Prospect describes pain in their own words. Bad: You told them what their pain should be. |
...
| Was it explored? | Good: "Tell me more about that." Bad: Jumped straight to a handle. |
...
**Purpose:** Look at pipeline data and find patterns in deals you win vs. deals you lose. Pure computation + LLM reasoning.
...
|---------|----------------|
| Stage where deals stall longest | Your bottleneck — need to improve at this stage |
| Stage where most deals die | Your kill zone — what's going wrong here? |
| Deals that closed fastest | Your "sweet spot" — what do easy wins share? |
...
**Purpose:** Fuse email, call, and deal analysis into a personal sales skill assessment and a specific coaching plan. Pure LLM reasoning.
...
**Purpose:** Produce the final coaching report — personal, actionable, encouraging. Not a performance review. A coaching session.
...
Your data shows clear strengths here. Keep doing these.
...
|---------------|---------------|----------------|
| Emails + calls + pipeline | Full coaching across every dimension | Best |
...
- **Run monthly for continuous improvement.** The coaching plan is built on 30-day cycles. Re-run and compare grades.
