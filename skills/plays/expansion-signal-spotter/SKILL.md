...
description: >
  Watch existing customer accounts for upsell and cross-sell signals: team growth
  on LinkedIn, new job postings, product usage patterns, funding announcements, and
  public news. Produces a weekly expansion opportunity list with context and talk
...
Surface expansion revenue hiding in your existing customer base. Watches accounts for signals that they're ready to buy more — before they ask, and before a competitor gets there first.

**Built for:** CS teams and founders at early-stage companies where expansion revenue is the fastest path to growth. The relationship is already there — this skill finds the timing.
...
5. **Key contacts to monitor** — LinkedIn URLs of champions, decision-makers per account (if known beyond the primary)

### Filters
6. **Minimum account value** — Only scan accounts above $X MRR? (Focus the effort)
7. **Accounts to exclude** — Anyone in active churn risk, paused, or in dispute
...
| **New leadership hire** | Budget holder arrived, will evaluate the stack | Executive alignment meeting |
| **Hiring in an adjacent team** | New department could use your product | Cross-sell / new use case |
...
| Signal | What It Means | Expansion Play |
|--------|---------------|----------------|
| **New funding round** | Cash on hand, expanding everything | Premium tier / annual contract |
...
### 1C: Product Usage Signals (if usage data is available)
...
| **New feature adoption** | Started using a feature in a higher tier (via trial/beta) | Convert trial to paid |
...
| **Warm** | 8-14 | Send a value-add touchpoint, plant the expansion seed |
| **Watch** | 3-7 | Add to the next QBR agenda, monitor |
