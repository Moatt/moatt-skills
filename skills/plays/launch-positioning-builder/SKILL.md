...
description: >
  Investigate competitors, analyse their messaging, and produce a positioning document
  with category definition, differentiation claims, value propositions, and proof
  points. Chains web research, competitor site analysis, and review mining to assemble
  a positioning doc ready for website copy and sales deck use. Use when a product
  marketing team needs to define or refresh positioning ahead of a launch, rebrand,
...
Investigate the competitive landscape and produce a complete positioning document — category definition, differentiation claims, value props, proof points, and messaging hierarchy. The output drops straight into website copy, sales decks, and investor materials.
...
2. **One-sentence pitch** — How do you currently describe what you do?
...
For each competitor, research and pull out:
...
- **Category language** — what category do they slot themselves into?
- **Key differentiators** — what do they emphasise?
...
Ad copy exposes what competitors believe converts — their sharpest positioning.

## Phase 2: Positioning Framework

Assemble the positioning doc using April Dunford's framework adapted for early-stage:
...
**Decision criteria:**
- If your ICP already searches for the category → use the existing or a subcategory framing
- If you'd burn 50% of sales calls explaining the category → don't invent a new one
...
Map each differentiator to customer value:
...
Build a 2x2 positioning matrix:
...
Save to the current working directory as `positioning-[YYYY-MM-DD].md` (or a user-specified path).
...
| Review mining (when using review-site-scraper) | ~$0.50-1.00 |
...
- **fetch_webpage** — for analysing competitor sites
