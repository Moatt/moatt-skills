...
description: >
  End-to-end Meta Ads campaign builder for Facebook and Instagram. Takes ICP +
  objective, generates audience targeting recommendations, ad set structure,
  copy framework per placement, and exports as a campaign brief or structured
  CSV. Focused on campaign architecture, not creative generation.
tags: [ads]
---

# Meta Ads Campaign Builder

Build a complete Meta Ads campaign structure — targeting, ad sets, placements, copy framework, and budget allocation. This skill owns the strategic architecture that determines whether a campaign succeeds before a single ad runs.

**Core principle:** The biggest Meta Ads mistake startups make is boosting a post and calling it a campaign. Proper campaign structure — objective selection, audience layering, placement optimisation, and testing framework — is what separates burning money from building pipeline.
...
| "Drive free trial sign-ups" | Conversions | Optimise for the on-site conversion event |
| "Build awareness for launch" | Awareness (Reach) | Maximise eyeballs in the target audience |
| "Retarget website visitors" | Conversions | Bring warm traffic back to convert |
| "Drive traffic to content" | Traffic | Optimise for clicks to blog/resource |
...
The Meta Ad Library (facebook.com/ads/library) is publicly accessible — search for competitor pages to see their active ads, formats, and messaging angles. Use what you find to shape copy angles and audience strategy.
...
Research the most relevant interests, behaviours, and demographics:
...
| **Interests** | [Tools they use, publications they read, topics they follow] | Behavioural proxy |
| **Behaviors** | [Business decision makers, technology early adopters, etc.] | Meta behavioural data |
...
B2B targeting on Meta is tougher. Recommended approach:

1. **Upload customer email lists** → Build lookalikes (best B2B signal)
2. **Layer interests with behaviours** — "Business decision makers" + "[specific software interest]"
...
### Per Placement, Build Copy Structure
...
| Awareness | Lowest Cost per 1K Impressions | Maximise reach |

### Learning Phase

**Critical:** Each ad set needs ~50 conversions/week to exit the learning phase. If your budget can't sustain that:
- Consolidate ad sets (fewer, larger audiences)
- Optimise toward an earlier-funnel event (e.g., "Add to Cart" instead of "Purchase")
- Start with Traffic or Landing Page Views objective, then switch to Conversions later
...
- [ ] Meta Pixel installed on every landing page
...
- [ ] All ad copy uploaded with the correct placements
...
- Day 14: First optimisation pass — pause losers, scale winners
```

Save to `meta-campaign-plan-[YYYY-MM-DD].md` in the current working directory (or a user-specified path).
...
- **web_search** — for audience research, targeting ideas, and competitor ad research via the Meta Ad Library
