...
1. **No AI video generation** — this skill only uses Ken Burns (zoom/pan on stills). For AI-animated clips, use the [`product-reel-generator`](https://github.com/Karmable-AI/moatt-skills-v3/tree/main/skills/kits/channels/video-production/product-reel-generator) skill which supports Higgsfield/Kling/Seedance video generation APIs.
