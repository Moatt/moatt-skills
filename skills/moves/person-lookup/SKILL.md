...
- Apollo `mixed_people/search`: **$0.01 flat** per call → `$MOATT_API_BASE/v1/proxy/apollo/mixed_people/search`
- Fiber `/v1/natural-language-search/profiles`: **$0.02/record** → `$MOATT_API_BASE/v1/proxy/fiber/v1/natural-language-search/profiles`
