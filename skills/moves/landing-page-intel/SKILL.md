...
description: >
  Pull competitor and customer intelligence out of any company's landing page HTML.
  Surfaces tech stack, analytics tools, ad pixels, customer logos, SEO metadata,
  CTAs, hidden elements, and more. No API keys required.
---

# Landing Page Intel

Mine GTM-relevant intelligence from any company's landing page by parsing its HTML source.
...
# Scan several pages of the same site
python3 skills/landing-page-intel/scripts/scrape_landing_page.py \
...
| **Hidden Elements** | Content inside `display:none`, `hidden`, or HTML comments that may leak upcoming features |
| **Infrastructure** | CMS platform (Webflow, WordPress, Next.js, etc.), inferred from HTML signatures |
...
- **Competitive intel**: See the tools competitors use, how they position themselves, and who their customers are
- **Prospect research**: Before a sales call, scan the prospect's site to read their stack and maturity
- **Market mapping**: Scan multiple competitors to compare positioning, customer segments, and GTM motions
- **Customer discovery**: Mine competitor customer logos as potential prospects for your own product

## Cost

Free. No API keys required. Uses plain HTTP requests against public HTML.
